...
public class ReportService extends ServiceBase {
    ...
    /**
     * 指定した従業員が作成した日報データを指定されたページ数の一覧画面に表示する分取得し、
     * ReportViewのリストで返却する
     * @param page ページ数
    ...
    /**
     * 指定されたページ数の一覧画面に表示すｒ日報データを取得し、ReportViewのリストで返却する
     * @param page ページ数
     * @return 一覧画面に表示するデータのリスト
     */
    ...
    /**
     * 画面から入力された日報の登録内容をもとにデータを一件作成し、日報テーブルに登録する
     * @param rv 日報の登録内容
    ...
    /**
     * 画面から入力された日報の登録内容をもとに日報データを更新する
     * @param rv 日報の更新内容
     * @return バリデーションで発生したエラーのリスト
     */
